...
const Dashboard = () => {
            ...
            {Array.from({ length: 3 }).map(
              (_, index) => (
                ...
                >
                  ...
                  <div className="mt-3 h-8 w-36 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-800" />
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="min-h-screen bg-slate-50 p-4 transition-colors dark:bg-slate-950 sm:p-6 lg:p-8"
    >
      ...
      <div className="mx-auto max-w-[1600px]">
        ...
        >
          ...
          <motion.button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white dark:text-slate-900"
          >
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              className="mb-6 overflow-hidden rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-500/20 dark:bg-red-500/10 dark:text-red-400"
            >
        ...
        >
          ...
          <motion.div
            ...
            className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-xl dark:border-slate-800 dark:bg-slate-900"
          >
            ...
            <div className="mt-3 flex items-end justify-between">
              ...
              <motion.div
                ...
                className="rounded-xl bg-blue-100 px-3 py-2 text-xl transition dark:bg-blue-500/10"
              >
                📦
              </motion.div>
          ...
          >
            ...
            <div className="mt-3 flex items-end justify-between">
              ...
              <motion.div
                ...
                className="rounded-xl bg-indigo-100 px-3 py-2 text-xl dark:bg-indigo-500/10"
              >
                🏷️
              </motion.div>
          ...
          >
            ...
            <div className="mt-3 flex items-end justify-between">
              ...
              <motion.div
                ...
                className="rounded-xl bg-amber-100 px-3 py-2 text-xl dark:bg-amber-500/10"
              >
                ⚠️
              </motion.div>
          ...
          >
            ...
            <div className="mt-3 flex items-end justify-between">
              ...
              <motion.div
                ...
                className="rounded-xl bg-red-100 px-3 py-2 text-xl dark:bg-red-500/10"
              >
                ❌
              </motion.div>
        ...
        >
          ...
          <motion.div
            ...
            className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-800 dark:bg-slate-900"
          >
                    ...
                    >
                      ...
                      <div className="flex gap-3">
                        ...
                        <motion.img
                          ...
                          className="h-16 w-16 shrink-0 rounded-xl border border-slate-200 object-cover shadow-sm dark:border-slate-700"
                          onError={(
                            event
                          ) => {
                            event.currentTarget.src =
